...
<html lang="en">
    ...
    <body>
        <h1 class="text-3xl text-center font-bold text-blue-500 my-10">{!! $jiri->name !!}</h1>
        <div class="flex">
        ...
        <a href="{{route('jiris.edit', $jiri)}}" class="p-2 mt-5 bg-orange-400 hover:cursor-pointer mx-auto w-40 text-white border transition-all border-orange-400 rounded-md hover:bg-white hover:text-orange-400">
            Modifier ce jiri
        </a>
    </body>
</html>
